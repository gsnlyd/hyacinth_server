defmodule HyacinthWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use HyacinthWeb.ConnCase, async: true`, although
  ...
  def log_in_user(conn, user) do
    token = Hyacinth.Accounts.generate_user_session_token(user)
